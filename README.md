...
> Be patient! In ~3 mins your app is live, at your [app url](https://container-c4iaupe.containers.anotherwebservice.com/). It even has a free SSL/TLS certificate 🔒 you're welcome!
...
Your app will be automatically re-deployed with the latest code at: https://container-c4iaupe.containers.anotherwebservice.com/
...
```
git clone git@github.com:ramones90/container-c4iaupe.git
cd container-c4iaupe
```
...
```
docker attach container-c4iaupe
```
